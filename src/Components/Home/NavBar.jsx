    ...
    <div className=" bg-white ">
      <div className=" max-w-[1170px] py-7 flex items-center justify-between mx-auto">
        ...
        <div className='flex gap-6 '>
          <Link className=" text-midBlue relative font-bold after:block after:content-[''] after:h-[400%] after:-top-[150%] after:w-[1px] after:bg-gray after:-right-3 after:absolute" to="/avocat-register">
